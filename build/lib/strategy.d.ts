 ...
 */
export declare type EnterPositionFn = (options?: IEnterPositionOptions) => void;
/**
 * Type for the function used to exit a position.
 */
export declare type ExitPositionFn = () => void;
/**
 ...
 */
export declare type StopLossFn<BarT extends IBar, ParametersT = any> = (args: IStopLossArgs<BarT, ParametersT>) => number;
/**
 ...
 */
export declare type ProfitTargetFn<BarT extends IBar, ParametersT = any> = (args: IProfitTargetArgs<BarT, ParametersT>) => number;
/**
 ...
 */
export declare type EntryRuleFn<BarT extends IBar, ParametersT = any> = (enterPosition: EnterPositionFn, args: IEntryRuleArgs<BarT, ParametersT>) => void;
/**
 ...
 */
export declare type ExitRuleFn<BarT extends IBar, ParametersT = any> = (exitPosition: ExitPositionFn, args: IExitRuleArgs<BarT, ParametersT>) => void;
/**
 ...
 */
export declare type PrepIndicatorsFn<InputBarT extends IBar, IndicatorsBarT extends InputBarT, ParametersT, IndexT> = (args: IPrepIndicatorsArgs<InputBarT, ParametersT, IndexT>) => IDataFrame<IndexT, IndicatorsBarT>;
/**
